...
public class IconsManager {
    ...
    public Drawable getPlaceIcon(Place place){
        return this.getCategoryIcon(place.getCategory());
    }

    public Drawable getCategoryIcon(PlaceCategory cat){
        ...
        String resourceName = "pic_" + symbol + "_48";
